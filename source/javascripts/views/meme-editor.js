...
MEME.MemeEditorView = Backbone.View.extend({
  ...
  buildForms: function() {
    ...
    if (d.textWhiteonredEdit) {
      $('#text-whiteonred').parent().show();
    }
  ...
  render: function() {
    ...
    this.$('#text-whiteonred').prop('checked', d.textWhiteonred);
  ...
  events: {
    ...
    'change #text-whiteonred': 'onTextWhiteonred',
  ...
  onTextWhiteonred: function() {
    this.model.set('textWhiteonred', this.$('#text-whiteonred').prop('checked'));
  },
  onFontSize: function() {
